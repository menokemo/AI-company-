...
def start_coding(full_name, task):
    """يرسل المهمة لـ code-writer الذي يكتب الكود ويرفعه على GitHub مباشرة"""
    CODE_WRITER_URL = os.environ.get("CODE_WRITER_URL", "http://ai-code-writer:9001")
    try:
        body = json.dumps({
            "task": task,
            "repo_full_name": full_name,
            "commit_msg": "🤖 Initial project code — generated by AI"
        }).encode()
        req = urllib.request.Request(f"{CODE_WRITER_URL}/write-code", data=body, method="POST")
        req.add_header("Content-Type", "application/json")
        with urllib.request.urlopen(req, timeout=180) as r:
            ...
            return {
                ...
                "pushed":      d.get("github", {}).get("pushed", []),
            }
