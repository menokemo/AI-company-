...
## الميزات (تتمة 2)
- **الوعي بالوقت**: Filter جديد (`tools-api/time_awareness_filter.py`) يحقن توقيتاً حقيقياً `[YYYY-MM-DD HH:MM]` في كل رسالة (من العميل ومن مدير المشروع)، فيقدر يحسّ بمرور الوقت الحقيقي (مثلاً لا يكرر "هبدأ الآن" بعد دقائق من قولها). يُرفع ويُفعَّل تلقائياً عبر `setup-openwebui.py`، مربوط بموديل "مدير المشروع" فقط (`filterIds`).
