...
| سكربت التثبيت | `install.sh` يشغّل كل شيء | 🔜 مخطّط | التسليم النهائي |
| البنية التحتية | `Docker` + `Portainer` | 🔜 مخطّط | الطبقة القادمة |
...
- **النماذج:** `API` سحابي قوي (جودة أعلى). النماذج المحلية مؤجّلة.
